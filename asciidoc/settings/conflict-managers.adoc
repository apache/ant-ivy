...
[ivysettings.conflict-managers]#Defines a list of link:../concept.html#conflict[conflict managers] usable in Ivy.# Each conflict manager is identified by its name, given as an attribute.
