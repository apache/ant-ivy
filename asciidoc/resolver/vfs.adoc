...
This resolver is certainly the most capable, since it relies on link:https://commons.apache.org/proper/commons-vfs/[Apache Commons VFS], which gives an uniform access to link:https://commons.apache.org/proper/commons-vfs/filesystems.html[a good number of file systems], including FTP, WebDAV, zip, ...
